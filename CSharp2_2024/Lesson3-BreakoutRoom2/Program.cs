namespace Lesson3_BreakoutRoom2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            // Tento ukol se opravuje sam. Kazdy priklad obsahuje kontrolni vypisy, ze jsi dosla k spravnemu vysledku.
...
it was the grayish white of old porridge.";
            ...
            // Time se snadno vylouci jakekoliv vyskyty "and" v ramci jinych slov.

            int pocetAnd = 0;

            Console.WriteLine("Text obsahuzje slovo 'and' celkem 5x - ".PadRight(padding) + (pocetAnd == 5));
        }
    }
}
